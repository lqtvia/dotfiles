...
hl.bind(mainMod .. " + Return", hl.dsp.exec_cmd("kitty --class floatterm"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("bash -c 'notify-send \"opening firefox\" && firefox'"))
...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd('bash -c "cliphist list | rofi -dmenu -i -theme ~/.config/rofi/config.rasi | cliphist decode | wl-copy"'))
...
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("bash ~/.config/hypr/scripts/brightness-lock.sh"))
